...
unless(defined(&_BITS_BYTESWAP_H)) {
	...
	eval 'sub __bswap_constant_64 {
	    my($x) = @_;
    	    eval q(( &__extension__ (((($x) & 1.83746864796716e+19) >> 56) | ((($x) & 7.17761190612173e+16) >> 40) | ((($x) & 280375465082880) >> 24) | ((($x) & 1095216660480) >> 8) | ((($x) & 0xff000000) << 8) | ((($x) & 0xff0000) << 24) | ((($x) & 0xff00) << 40) | ((($x) & 0xff) << 56))));
