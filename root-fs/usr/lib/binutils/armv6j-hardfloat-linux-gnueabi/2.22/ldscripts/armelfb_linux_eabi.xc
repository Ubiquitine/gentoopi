...
OUTPUT_ARCH(arm)
ENTRY(_start)
SEARCH_DIR("/usr/armv6j-hardfloat-linux-gnueabi/lib"); SEARCH_DIR("/usr/lib/binutils/armv6j-hardfloat-linux-gnueabi/2.22"); SEARCH_DIR("/usr/local/lib"); SEARCH_DIR("/lib"); SEARCH_DIR("/usr/lib");
SECTIONS
{
